...
module.exports = {
  ...
  execute: async (message, args, client, prefix) => {
    try {
            ...
            console.log(`${user} used PLAY Command TIME: ${date.toLocaleString()}`);
        } catch (err) {
            console.log(err);
        }
    ...
    //if (!player.connect()) 
    //return message.channel.send({ embeds: [new MessageEmbed().setColor(client.embedColor)//.setDescription(`Can't Connect to the VoiceChanel`)] });
